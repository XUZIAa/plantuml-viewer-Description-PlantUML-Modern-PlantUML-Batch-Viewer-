...
<pre>
example/
├── codes/                  <span style="color: #6a737d"># [输入] 这里存放你编写的 puml 代码</span>
│   ├── usecase.puml
│   └── architecture.puml
├── images/                 <span style="color: #6a737d"># [输出] 软件会自动将生成的图片保存在这里</span>
│   ├── usecase.png
│   └── architecture.png
└── .plantuml_project.json  <span style="color: #6a737d"># [配置] 项目配置文件，自动生成</span>
</pre>
